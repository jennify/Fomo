...
class HamburgerButton : UIButton {
    ...
    var menuColor: UIColor = UIColor.fomoHighlight()
    var closeColor: UIColor = UIColor.fomoHamburgerBGColor()
    var size: CGFloat = 30
    var menu: Bool = false
    ...
    override func drawRect(rect: CGRect) {
        ...
        for layer in [ self.top, self.middle, self.bottom ] {
            ...
            let strokingPath = CGPathCreateCopyByStrokingPath(layer.path, nil, strokeSize, .Round, .Miter, 100)
