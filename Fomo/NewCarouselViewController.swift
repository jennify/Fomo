...
class NewCarouselViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        scrollView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(NewCarouselViewController.onTap)))
    }
